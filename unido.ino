...
volatile long contador_anterior_L = 0;
...
volatile long contador_anterior_R = 0;

// ************************* variables para tiempo / calculo de velocidad ***
unsigned long ta1, ta2, dif_tiempo;
long int cont1,cont2, dif_cont_L=0;
long l_lastT = 0;
...
float msg_angular_z = 0.0;
float msg_linear_x = 0.0;
...
void velocidad( const geometry_msgs::Twist& velocidad)
{
